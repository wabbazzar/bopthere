...
import { Calendar, Clock, MapPin, Star, Utensils, Heart, PartyPopper, Users, TreePine, Home } from 'lucide-react';
...
const characterMessages = {
  wesley: {
    ...
    message: "Four days of legendary adventures await! From heroic hikes through mystical mountains to the grand wedding ceremony quest, every moment is a step in your epic journey through the enchanted lands of Maui."
  },
  heather: {
    title: "Our Wedding Itinerary", 
    subtitle: "A beautiful journey through our celebration",
    message: "Four magical days of love and celebration await us. From romantic sunset ceremonies to elegant receptions, every moment has been crafted with care to create the most beautiful memories with our beloved family and friends."
  },
  puffy: {
    title: "The Ultimate Party Schedule",
    subtitle: "Four days of the best fun ever!",
    message: "Four days of pure fun and coziness! I've personally tested all the nap spots and confirmed - the food is amazing, the games are epic, and there are so many comfortable places to relax between all the exciting activities!"
  }
};
...
const getActivityColor = (type: Activity['type']) => {
  switch (type) {
    case 'logistics': return '#6B7280'; // gray
    case 'social': return '#3B82F6'; // blue
    case 'activity': return '#10B981'; // emerald
    case 'food': return '#F59E0B'; // amber
    case 'ceremony': return '#EC4899'; // pink
    case 'reception': return '#8B5CF6'; // violet
    case 'party': return '#EF4444'; // red
