...
class TestAuthenticationE2E:
    ...
    def test_dynamodb_table_exists(self):
        ...
        try:
            ...
            response = self.session.client("dynamodb").describe_table(
    ...
    def test_user_login_invalid_credentials(self):
        ...
        login_data = {"username": self.test_username, "password": "wrongpassword"}
    ...
    def test_token_verification_success(self):
        ...
        ), f"Token verification failed: {response.text}"
        ...
        ), "Password hash exposed in verification response"
    ...
    def test_sql_injection_protection(self):
        ...
        login_data = {"username": malicious_input, "password": "anypassword"}
    ...
    def test_rate_limiting_protection(self):
        ...
        for status_code in responses:
            assert (
                status_code in acceptable_codes
            ), f"Unexpected status code during rate limit test: {status_code}"
    ...
    def test_concurrent_logins(self):
        ...
        for response in responses:
            assert (
                response.status_code == 200
            ), f"Concurrent login failed: {response.text}"
            data = response.json()
    ...
    def test_dynamodb_update_on_login(self):
        ...
        assert (
            updated_last_login != initial_last_login
        ), "last_login should be updated on login"
        ...
        assert (
            updated_dt > initial_dt
        ), "Updated last_login should be later than initial"
    ...
    def test_user_registration_flow(self):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                # Validate response structure
                assert (
                    "user" in data or "id" in data
                ), "Registration response missing user info"
                ...
                try:
                    ...
                    print(
                        f"Warning: Failed to cleanup registered user: {cleanup_error}"
                    )
...
class TestAuthenticationIntegration:
    ...
    def test_field_consistency_with_frontend_types(self):
        ...
        expected_login_response_fields = {"token", "user", "expires_at"}
        ...
        assert (
            len(expected_login_response_fields) == 3
        ), "LoginResponse should have 3 fields"
    ...
    def test_jwt_token_structure(self):
        ...
        payload = (
            base64.urlsafe_b64encode(b'{"sub":"user123","exp":1234567890}')
            .decode()
            .rstrip("=")
        )
