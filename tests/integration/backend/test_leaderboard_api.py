...
class TestLeaderboardAPI:
    ...
    def test_get_leaderboard_cors(self):
        ...
        assert response.headers['access-control-allow-origin'] == 'https://heatherandwesley.com'
    ...
    def test_post_with_auth(self):
        ...
        submitted_score = next((s for s in scores if s['username'] == 'api-integration-test'), None)
    ...
    def test_score_submission_flow(self):
        ...
        our_score = next((s for s in scores if s['username'] == 'flow-test-user' and s['score'] == timestamp), None)
