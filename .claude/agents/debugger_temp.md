...
The debugger agent MUST follow the test-driven debugging (TDD) workflow for the wedding app's comprehensive testing infrastructure.
...
1. **Run Tests**
   ...
   npm test -- components/LoginModal   # Specific component tests
