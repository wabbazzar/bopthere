...
{
  "prompts": [
   "Take a picture with someone in the group you didn't know"
   ...
   "Take a picture with someone in the same birth month"
   "Selfie with a waterfall"
   "Make a toast"
   "Take a video of your best dance moves"
   "Take a picture with someone eating a piece of dessert Lady and Tramp style"
   "Take a video of you doing a cartwheel" 
   "Take a picture with Wesley and Heathre together"
   "Take a picture of you jumping into the pool"
   "Take a picture of you doing some type of water activity" 
   "Take a picture of fishies eating your toes"
   "Take a picture of you getting lei'ed" 
   "Selfie wit the sunrise" 
   "Take a picture of a group hug with 5+ people"
   "Take a picture wearing a flower crown"
   "Take a picture with the most Hawaiian thing you can find" 
   "Photobomb someone's picture (and get proof)"
   "Capture a candid moment of Heather and Wesley"
   "Take a picture of you doing yoga" 
   "Take a picture of you + 4 other people spelling out ALOHA with your body"
  ]
}
```
